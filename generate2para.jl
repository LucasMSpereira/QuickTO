using Makie, TopOpt, Parameters, StatProfilerHTML, Printf, HDF5, Statistics, FLoops
...
@with_kw mutable struct FEAparameters
    ...
    quants::Int = 10 # number of problems
    ...
    fileID = createFile2(quants,meshSize...)
end
...
function loopTO(FEAparameters)
    ...
    @floop for i in 1:FEAparameters.quants
...
# @time plotSample2(FEAparams.quants, FEAparams)
