...
@with_kw mutable struct FEAparameters
    quants::Int = 1000 # number of TO problems per section
    V::Array{Real} = [0.3+rand()*0.6 for i in 1:quants] # volume fractions
    ...
    section::Int = 5 # Number of dataset HDF5 files with "quants" samples each
end
