...
function readAnalysis(pathRef)
  file = h5open("C:/Users/LucasKaoid/Desktop/datasets/post/"*pathRef, "r")
...
function stressCNNdata(id, numFiles, FEAparams)
  ...
  stressCNNdata = h5open("C:/Users/LucasKaoid/Desktop/datasets/data/stressCNNdata/$nSamples $(rand(1:99999))", "w")
